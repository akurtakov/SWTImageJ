...
To identify them in the WindowManager (responsible to address open images, etc.) an interface has been created [ij.plugin.frame.swt.WindowSwt][ij.plugin.frame.swt.WindowSwt](https://github.com/eclipse-swtimagej/SWTImageJ/blob/develop/org.eclipse.swt.imagej/src/ij/plugin/frame/swt/WindowSwt.java) implemented by dialogs, etc., 
